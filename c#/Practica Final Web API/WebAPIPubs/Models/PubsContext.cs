...
namespace WebAPIPubs.Models
{
    public partial class PubsContext : DbContext
    {
        ...
        public virtual DbSet<VAuthorsTitleCook> VAuthorsTitleCooks { get; set; }
        public virtual DbSet<VAutoresPublicadore> VAutoresPublicadores { get; set; }
...
//            }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<VAuthorsTitleCook>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vAuthorsTitleCook");
            ...
            modelBuilder.Entity<VAutoresPublicadore>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vAutoresPublicadores");
